...
export default function INRDepositForm() {
  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      <h2 className="text-2xl font-bold text-[#00E5FF] text-center pt-2">Security Deposit</h2>

      {/* Bank Details Card */}
      <Card className="bg-[#1C2431] border-[#00E5FF]/20 p-5 space-y-4">
        <h3 className="text-[#00E5FF] font-semibold text-lg mb-3">Bank Details</h3>
        {bankDetails && (
          <div className="space-y-3">
            {/* Bank Name */}
            <div className="p-3 bg-[#0B1C14] rounded-lg border border-[#00E5FF]/10">
              <p className="text-gray-400 text-xs mb-1">Bank Name</p>
              <p className="text-white font-medium text-base">{bankDetails.bankName}</p>
            </div>
            ...
            <div className="p-3 bg-[#0B1C14] rounded-lg border border-[#00E5FF]/10 flex justify-between items-center gap-3">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-white font-medium text-base break-all">{bankDetails.accountNumber}</p>
              </div>
              <Button
            ...
            <div className="p-3 bg-[#0B1C14] rounded-lg border border-[#00E5FF]/10 flex justify-between items-center gap-3">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-white font-medium text-base">{bankDetails.ifsc}</p>
              </div>
              <Button
            ...
            <div className="p-3 bg-[#0B1C14] rounded-lg border border-[#00E5FF]/10">
              ...
              <p className="text-white font-medium text-base">{bankDetails.accountHolder}</p>
            </div>
          </div>
        )}
      </Card>
      ...
      {/* UPI QR Code Card */}
      <Card className="bg-[#1C2431] border-[#00E5FF]/20 p-5 space-y-4">
        <h3 className="text-[#00E5FF] font-semibold text-lg text-center">UPI QR Code</h3>
